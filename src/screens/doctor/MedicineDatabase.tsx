// Medicine Database - Doctor's medicine database and search
...
const MedicineDatabase: React.FC = () => {
  ...
  const addToPrescription = (medicine: Medicine) => {
    Alert.alert(
      'Add to Prescription',
      `Add ${medicine.genericName} to current prescription?`,
      [
        { text: 'Cancel', style: 'cancel' },
        { 
          text: 'Add', 
          onPress: () => {
            Alert.alert('Success', 'Medicine added to prescription')
          }
        }
      ]
    )
    ...
    >
      ...
      <View style={styles.medicineFooter}>
        ...
        <TouchableOpacity
          ...
          onPress={() => addToPrescription(item)}
        >
